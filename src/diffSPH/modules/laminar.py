...
@torch.jit.script
def computeLaminarViscosity(i, j, ri, rj, Vi, Vj, distances, radialDistances, support : float, numParticles : int, eps : float, rhoi, rhoj, ui, uj, alpha : float, c0 : float, restDensity : float):
