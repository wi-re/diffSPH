...
@torch.jit.script
def computePressureAccel(i, j, ri, rj, Vi, Vj, distances, radialDistances, support : float, numParticles : int, eps : float, rhoi, rhoj, pi, pj):
...
@torch.jit.script
def computePressureAccelDeltaPlus(i, j, ri, rj, Vi, Vj, distances, radialDistances, support : float, numParticles : int, eps : float, rhoi, rhoj, pi, pj, surfaceMask):
    gradW = kernelGradient(radialDistances, distances, support)
