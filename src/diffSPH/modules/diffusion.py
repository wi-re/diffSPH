...
@torch.jit.script
def computeVelocityDiffusionA(i, j, ri, rj, Vi, Vj, distances, radialDistances, support : float, numParticles : int, eps : float, rhoi, rhoj, ui, uj, alpha : float, c0 : float, restDensity : float):
...
@torch.jit.script
def computeVelocityDiffusion(i, j, ri, rj, Vi, Vj, distances, radialDistances, support : float, numParticles : int, eps : float, rhoi, rhoj, ui, uj, alpha : float, c0 : float, restDensity : float):
    gradW = kernelGradient(radialDistances, distances, support)
