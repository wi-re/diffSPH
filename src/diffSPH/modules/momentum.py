...
@torch.jit.script
def computeDivergenceTermPrice(i, j, ri, rj, Vi, Vj, distances, radialDistances, support : float, numParticles : int, eps : float, rhoi, rhoj, ui, uj):
...
@torch.jit.script
def computeDivergenceTermDelta(i, j, ri, rj, Vi, Vj, distances, radialDistances, support : float, numParticles : int, eps : float, rhoi, rhoj, ui, uj):
    gradW = kernelGradient(radialDistances, distances, support)
