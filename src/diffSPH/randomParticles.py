...
#     noise = noise[:n,:n] / 255
    ...
    xx, yy = np.meshgrid(x,y)
    print('Test')
    xx,yy, noise = generateOctaveNoise(n, dim=2, octaves = octaves, lacunarity = lacunarity, persistance = persistance, baseFrequency = res, tileable = True, seed = seed, kind = 'simplex')
...
# from .randomParticles import generate_fractal_noise_2d
...
from .randomParticles import createPotentialFieldTileable
from .util import evalArea
from .modules.neighborSearch import radiusCompactHashMap, periodicNeighborSearch
from .modules.periodicBC import createGhostParticlesKernel
...
# from .simplex import getOctaveSimplexNoisePeriodic, getSimplexNoisePeriodic, _init
