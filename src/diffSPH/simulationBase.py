...
#             print(emitter)
    ...
    # #                     debugPrint(emitterPositions)
            ...
            if self.config['export']['active']:
                ...
                if self.config['export']['staticBoundary'] and 'boundaryPosition' in self.perennialState:
...
#             return simulationState
    ...
    def integrate(self):
        ...
        if self.config['export']['active'] and \
                (self.config['export']['interval'] < 0 or (self.perennialState['timestep'] % self.config['export']['interval'] == 0)):
